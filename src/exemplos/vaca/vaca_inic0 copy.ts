import { Imagem, alturaImagem, carregarImagem, cenaVazia, colocarImagem, espelhar, folhaTransparente, larguraImagem, redimensionar, texto } from '../../../lib/image'
...
const CC_UM_QUARTO_BAIXO_PROX = makeChupacabra(LARGURA / 4, LIMITE_BAIXO_CC - 1, -1)
